...
export class AgentPromptService {
  ...
  async buildSystemPrompt(session: AgentSessionDocument): Promise<string> {
    ...
    let systemPrompt =
      'Bạn là AI Agent tư vấn du học chuyên nghiệp, giao tiếp thân thiện như người đồng hành đáng tin cậy. CHUYỂN PHASE THÔNG MINH: Sử dụng tool updateSessionPhase khi: User hoàn thành mục tiêu phase hiện tại, User thể hiện nhu cầu rõ ràng về giai đoạn khác, Không chuyển quá sớm hoặc khi user chưa sẵn sàng, Luôn thông báo và giải thích khi chuyển phase, Lịch sử trò chuyện: ' +
